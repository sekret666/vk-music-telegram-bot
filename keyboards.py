...
class Keyboards:
    ...
    def for_user_playlist(self, list_page, user_id, count):
        ...
        try:
            ...
            keyboards[f"playlist_{self.user_id}"] = types.InlineKeyboardMarkup(row_width=len(buttons))
    ...
    def settings(self, lang, count, button_status):
        ...
        change_lang = types.InlineKeyboardButton(text=messages.change_language[self.lang], callback_data=f"change_lang")
        count_result = types.InlineKeyboardButton(text=messages.change_count_results[self.lang]+str(self.count), callback_data=f"count_result")
        heart_buttons = types.InlineKeyboardButton(text=messages.del_button_with_hearts[self.lang]+self.button_status, callback_data=f"heart_buttons")
        close = types.InlineKeyboardButton(text="❌", callback_data=f"close")
