...
start_messages = {
    "RU" :"""
Просто отправьте мне имя артиста и/или название композиции, и я найду эту композицию!
...
/my — your playlist
                """,
    "ES": """
¡Mándeme un cantante y/o nombre de una canción y encontraré la música para usted!
